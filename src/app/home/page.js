...
export default function Page() {
  return (
    <div className="flex flex-col ">
      ...
      <div className="flex flex-row justify-between   w-[100rem] mad4:w-[90rem] mad3:w-[81rem] mad2:w-[81rem]  h-[5.3rem] border border-black/20  mt-[3rem] rounded-[1rem] mr-[5rem] ml-[5rem] ">
      ...
      <div className="flex flex-row   mr-[5rem] ml-[5rem] gap-5 mad4:gap-10 mt-[3rem] mad3:flex mad3:flex-row mad3:justify-between  mad2:flex mad2:flex-row mad2:justify-between mad4:flex mad4:flex-row mad4:justify-between">
