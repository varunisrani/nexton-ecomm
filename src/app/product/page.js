      ...
      <div className="flex flex-row mt-5">
        ...
        <div className="flex ">
          <Image
            ...
            height={625}
            width={625}
            className="mt-6 rounded-xl mad4:hidden mad3:hidden mad2:hidden"
            alt=""
          />
          <Image
            src="https://i.ibb.co/4gGzqdK/image.png"
            height={800}
            width={2000}
            className="mt-6 rounded-xl mad5:hidden mad4:w-[45rem] mad3:w-[50rem] mad2:w-[50rem]"
            alt=""
          />
          <div className="mt-6 ml-[8rem] mad3:ml-[2rem] mad2:ml-[2rem]">
            <Box />
          </div>
        </div>
      </div>
