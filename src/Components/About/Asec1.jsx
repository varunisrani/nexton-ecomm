  ...
  return (
    <>
      ...
      <div className="flex flex-row mt-10">
        ...
        />
        <div className="flex flex-col ml-[20rem] mt-[10rem] mad3:mt-[6rem] mad3:ml-[10rem]  mad2:mt-[6rem] mad2:ml-[10rem] mad4:ml-[10rem]">
          <h1 className="w-[35rem] text-5xl font-medium mad2:text-4xl ">
      ...
      <div className="flex flex-row mt-[5rem]">
        <div className="flex flex-col ml-[0rem] mt-[10rem] mad3:mt-[6rem] mad2:mt-[6rem]">
          <h1 className="w-[35rem] text-5xl font-medium mad2:text-4xl ">
            Provide fashionable and qualifed products
          </h1>
        ...
        <Image
          ...
          width="550"
          alt=""
          className="rounded-2xl ml-[27rem] mad3:ml-[10rem] mad2:ml-[10rem] mad4:ml-[10rem]"
        />
      </div>
    </>
  );
