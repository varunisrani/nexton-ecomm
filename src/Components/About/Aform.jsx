...
export default function Aform() {
  return (
    <div className="flex flex-row mt-[10rem]">
      ...
      <div className="flex flex-col mad4:ml-[30rem]">
        <div className="flex flex-col mt-5 ml-[30rem] mad4:ml-[0rem]">
        ...
        <div className="flex flex-col mt-5 ml-[52.5rem] mad4:ml-[0rem]">
        ...
        <div className="flex flex-col mt-5 ml-[53.6rem] mad4:ml-[0rem]">
